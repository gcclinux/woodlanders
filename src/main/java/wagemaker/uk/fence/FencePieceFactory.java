...
public class FencePieceFactory {
    ...
    /**
     * Creates a fence piece of the specified type at the given position with
     * ownership.
     * 
     * @param type    The type of fence piece to create
     * @param x       World X coordinate
    ...
    public static int calculateMaterialRequirement(Rectangle bounds) {
        ...
        // Perimeter calculation: 2 * (width + height) - 4 to avoid double-counting
        // corners
        return 2 * (width + height) - 4;
    }

    /**
     * Calculates the material requirement for a rectangular enclosure of given
     * dimensions.
     * Convenience method that creates a Rectangle and calculates material
     * requirement.
     * 
    ...
    /**
     * Determines the appropriate fence piece type for a position within a
     * rectangular pattern.

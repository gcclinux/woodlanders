...
/**
 * Resource manager for fence system that handles memory management, resource cleanup,
...
public class FenceResourceManager implements Disposable {
    ...
    public static class MemoryStats {
        ...
        public int getActiveStructureManagers() { return activeStructureManagers; }
        public int getActiveRenderers() { return activeRenderers; }
        public int getAtlasReferences() { return atlasReferences; }
        public int getTotalPooledObjects() { return totalPooledObjects; }
        public Map<String, Integer> getPoolSizes() { return new HashMap<>(poolSizes); }
